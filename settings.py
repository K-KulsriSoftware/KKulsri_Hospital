...
# EMAIL_HOST_USER = 'siwanont.devtest@gmail.com'
# EMAIL_HOST_PASSWORD = 'aCHArdAREANTypOTERydEnTeLIScorGARgarChMelEmADClaCKSONeCErUdethYMPleNTOrTeMItANEStENItUDeRICKItIFrINT'
# EMAIL_PORT = 587
